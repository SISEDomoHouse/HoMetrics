...
class HousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create house" do
    assert_difference('House.count') do
      post houses_url, params: { house: { address: @house.address, stratum: @house.stratum } }
    end
  ...
  test "should update house" do
    patch house_url(@house), params: { house: { address: @house.address, stratum: @house.stratum } }
